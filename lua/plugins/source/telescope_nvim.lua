...
vim.api.nvim_set_keymap('n', '[finder]s', ':lua require("telescope.builtin").find_files({cwd = "$PRIVATE_DOTFILES_DIR/source_memo/"})<CR>', { noremap = true, silent = true, nowait = true })
...
vim.api.nvim_set_keymap('n', '[finder]t', ':lua require("telescope.command").load_command("tempaste")<CR>', { noremap = true, silent = false, nowait = true })
