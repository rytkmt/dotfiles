...
function! s:yank_git_branch()
  let l:branch = s:fetch_git_branch()
...
function! s:yank_gitlab_file_url(with_line)
  ...
  " エスケープシーケンスは削除
  let l:git_branch = s:fetch_git_branch()
  let l:path = l:git_project_path . "/-/tree/" . l:git_branch . "/". FilePathUnderRoot()
